const styles = `
  ...
  * { box-sizing: border-box; }
  ...
  .nav-links { display: flex; gap: 18px; color: #40505b; font-size: 0.94rem; }
  .hero {
    display: grid;
  ...
  .terminal-bar { display: flex; gap: 8px; padding: 14px 16px; border-bottom: 1px solid rgba(255, 255, 255, 0.12); }
  .terminal-bar span { width: 11px; height: 11px; border-radius: 50%; background: #d6654a; }
  ...
  .band, .split { width: min(1160px, calc(100% - 40px)); margin: 0 auto; padding: 84px 0; }
  ...
  ul { display: grid; gap: 10px; margin: 0; padding-left: 20px; color: #40505b; line-height: 1.5; }
  .split { display: grid; grid-template-columns: minmax(260px, 0.8fr) minmax(0, 1.2fr); gap: 28px; }
  .project-list { display: grid; gap: 14px; }
  .project-list article { min-height: 0; }
  .project-list p { margin-bottom: 0; color: #40505b; line-height: 1.55; }
    ...
    <>
      ...
      <main>
        <nav className="topbar" aria-label="Primary navigation">
          <a className="brand" href="#top">Learn-Cobol</a>
        ...
        <section className="hero" id="top">
          <div className="hero-copy">
            ...
            <div className="actions">
              <a className="button primary" href="#workflow">Start path</a>
              <a className="button secondary" href="#commands">Run locally</a>
            </div>
          </div>
